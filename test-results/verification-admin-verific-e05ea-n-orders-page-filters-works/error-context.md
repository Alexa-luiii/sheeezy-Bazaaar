...
- Name: verification/admin-verification.spec.ts >> admin orders page filters works
- Location: verification/admin-verification.spec.ts:22:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/admin/orders
Call log:
  - navigating to "http://localhost:3000/admin/orders", waiting until "load"
