              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="bg-surface p-6 border border-white/5">
                    <h4 className="text-white font-bold uppercase tracking-widest mb-4">Standard</h4>
                    <p className="text-white/60 text-sm mb-2">5-7 Business Days</p>
                    <p className="text-accent font-bold">FREE</p>
                  </div>
                  <div className="bg-surface p-6 border border-white/5">
                    <h4 className="text-white font-bold uppercase tracking-widest mb-4">Express</h4>
                    <p className="text-white/60 text-sm mb-2">2-3 Business Days</p>
                    <p className="text-white font-bold">$15.00</p>
                  </div>
                  <div className="bg-surface p-6 border border-white/5">
                    <h4 className="text-white font-bold uppercase tracking-widest mb-4">Next Day</h4>
                    <p className="text-white/60 text-sm mb-2">1 Business Day</p>
                    <p className="text-white font-bold">$30.00</p>
                  </div>
                </div>
